...
export const SectionTheorem: React.FC<SectionProps> = ({ lang, onComplete, isLocked, studentEmail, sessionId }) => {
  ...
  const challengeProblems: ChallengeItem[] = [
      ...
      statement: {
        ca: (<>
          <svg viewBox="0 0 180 120" width="140" height="93" className="float-right ml-3 mb-1">
            {/* Left and right triangles filled */}
            <polygon points="10,100 50,100 50,20" fill="#bfdbfe" opacity="0.7"/>
            <polygon points="130,100 170,100 130,20" fill="#bfdbfe" opacity="0.7"/>
    ...
    // ── AMPLIACIÓ A: 15 problemes nous ──────────────────────────────────
    {
      id: 'ex1', num: 11,
      title: { ca: "El rombe i les seves diagonals", es: "El rombo y sus diagonales" },
      statement: {
        ca: (<>
          <svg viewBox="0 0 160 140" width="130" height="113" className="float-right ml-3 mb-1">
            <polygon points="80,10 150,70 80,130 10,70" fill="#fef9c3" stroke="#ca8a04" strokeWidth="2"/>
            <line x1="10" y1="70" x2="150" y2="70" stroke="#2563eb" strokeWidth="1.5" strokeDasharray="5,3"/>
            <line x1="80" y1="10" x2="80" y2="130" stroke="#dc2626" strokeWidth="1.5" strokeDasharray="5,3"/>
            <rect x="80" y="70" width="7" height="7" fill="none" stroke="#6b7280" strokeWidth="1.2"/>
            <circle cx="80" cy="70" r="3" fill="#ca8a04"/>
          </svg>
          Un rombe té les seves dues diagonals: la major fa <strong>30 cm</strong> i la menor fa <strong>16 cm</strong>. Calcula la longitud del <strong>costat del rombe</strong>.
        </>),
        es: (<>
          <svg viewBox="0 0 160 140" width="130" height="113" className="float-right ml-3 mb-1">
            <polygon points="80,10 150,70 80,130 10,70" fill="#fef9c3" stroke="#ca8a04" strokeWidth="2"/>
          ...
          Un rombo tiene sus dos diagonales: la mayor mide <strong>30 cm</strong> y la menor mide <strong>16 cm</strong>. Calcula la longitud del <strong>lado del rombo</strong>.
        </>),
      },
      hint: { ca: "Les diagonals d'un rombe es tallen perpendicularment pel centre.", es: "Las diagonales de un rombo se cortan perpendicularmente por el centro." },
      unit: "cm", ans: 17, tol: 0.05,
    },
    {
      id: 'ex2', num: 12,
      title: { ca: "El rombe des de l'àrea", es: "El rombo desde el área" },
      statement: {
        ca: <>L'àrea d'un rombe és de <strong>30 cm²</strong> i la seva diagonal major fa <strong>12 cm</strong>. Calcula la longitud del <strong>costat del rombe</strong>.</>,
        es: <>El área de un rombo es de <strong>30 cm²</strong> y su diagonal mayor mide <strong>12 cm</strong>. Calcula la longitud del <strong>lado del rombo</strong>.</>,
      },
      hint: { ca: "Àrea del rombe = (D×d)/2. Aïlla la diagonal menor i llavors usa les semidiagonals.", es: "Área del rombo = (D×d)/2. Despeja la diagonal menor y luego usa las semidiagonales." },
      unit: "cm", ans: 6.5, tol: 0.05,
    },
    {
      id: 'ex3', num: 13,
      title: { ca: "El quadrat des de la diagonal", es: "El cuadrado desde la diagonal" },
      statement: {
        ca: (<>
          <svg viewBox="0 0 130 130" width="110" height="110" className="float-right ml-3 mb-1">
            <rect x="15" y="15" width="100" height="100" fill="#eff6ff" stroke="#2563eb" strokeWidth="2"/>
            <line x1="15" y1="15" x2="115" y2="115" stroke="#dc2626" strokeWidth="2" strokeDasharray="5,3"/>
            <text x="75" y="58" fill="#dc2626" fontSize="11" fontWeight="bold">18 cm</text>
          </svg>
          La diagonal d'un quadrat fa exactament <strong>18 cm</strong>. Calcula quant mesura el <strong>costat d'aquest quadrat</strong>.
        </>),
        es: (<>
          <svg viewBox="0 0 130 130" width="110" height="110" className="float-right ml-3 mb-1">
            <rect x="15" y="15" width="100" height="100" fill="#eff6ff" stroke="#2563eb" strokeWidth="2"/>
          ...
          La diagonal de un cuadrado mide exactamente <strong>18 cm</strong>. Calcula cuánto mide el <strong>lado de este cuadrado</strong>.
        </>),
      },
      hint: { ca: "La diagonal forma dos triangles rectangles on els dos catets (costats) són iguals.", es: "La diagonal forma dos triángulos rectángulos donde los dos catetos (lados) son iguales." },
      unit: "cm", ans: Math.sqrt(162), tol: 0.05,
    },
    {
      id: 'ex4', num: 14,
      title: { ca: "L'àrea del triangle isòsceles", es: "El área del triángulo isósceles" },
      statement: {
        ca: (<>
          <svg viewBox="0 0 160 130" width="130" height="106" className="float-right ml-3 mb-1">
            <polygon points="80,10 150,110 10,110" fill="#fce7f3" stroke="#9333ea" strokeWidth="2"/>
            <line x1="80" y1="10" x2="80" y2="110" stroke="#2563eb" strokeWidth="1.5" strokeDasharray="4,3"/>
            <rect x="80" y="103" width="7" height="7" fill="none" stroke="#2563eb" strokeWidth="1.2"/>
            <line x1="10" y1="117" x2="150" y2="117" stroke="#9333ea" strokeWidth="1.5"/>
            <text x="80" y="126" textAnchor="middle" fill="#9333ea" fontSize="11" fontWeight="bold">10 cm</text>
            <text x="25" y="58" fill="#ca8a04" fontSize="11" fontWeight="bold">13 cm</text>
          </svg>
          Un triangle isòsceles té una base de <strong>10 cm</strong> i els dos costats iguals mesuren <strong>13 cm</strong> cadascun. Calcula l'<strong>àrea total</strong> del triangle (en cm²).
        </>),
        es: (<>
          <svg viewBox="0 0 160 130" width="130" height="106" className="float-right ml-3 mb-1">
            <polygon points="80,10 150,110 10,110" fill="#fce7f3" stroke="#9333ea" strokeWidth="2"/>
          ...
          Un triángulo isósceles tiene una base de <strong>10 cm</strong> y los dos lados iguales miden <strong>13 cm</strong> cada uno. Calcula el <strong>área total</strong> del triángulo (en cm²).
        </>),
      },
      hint: { ca: "L'alçada d'un triangle isòsceles cau just al mig de la base.", es: "La altura de un triángulo isósceles cae justo en la mitad de la base." },
      unit: "cm²", ans: 60, tol: 0.05,
    },
    {
      id: 'ex5', num: 15,
      title: { ca: "La diagonal del rectangle", es: "La diagonal del rectángulo" },
      statement: {
        ca: <>Un rectangle té un perímetre de <strong>140 cm</strong> i un dels seus costats fa <strong>30 cm</strong>. Calcula la longitud de la seva <strong>diagonal</strong>.</>,
        es: <>Un rectángulo tiene un perímetro de <strong>140 cm</strong> y uno de sus lados mide <strong>30 cm</strong>. Calcula la longitud de su <strong>diagonal</strong>.</>,
      },
      hint: { ca: "Usa el perímetre per trobar l'altre costat: P = 2×(base + altura).", es: "Usa el perímetro para encontrar el otro lado: P = 2×(base + altura)." },
      unit: "cm", ans: 50, tol: 0.05,
    },
    {
      id: 'ex6', num: 16,
      title: { ca: "El perímetre del trapezi isòsceles", es: "El perímetro del trapecio isósceles" },
      statement: {
        ca: (<>
          <svg viewBox="0 0 180 120" width="140" height="93" className="float-right ml-3 mb-1">
            <polygon points="20,100 160,100 130,20 50,20" fill="#e0f2fe" stroke="#0369a1" strokeWidth="2"/>
            <line x1="50" y1="20" x2="50" y2="100" stroke="#2563eb" strokeWidth="1.5" strokeDasharray="5,3"/>
            <rect x="43" y="92" width="7" height="7" fill="none" stroke="#2563eb" strokeWidth="1.2"/>
            <text x="90" y="15" textAnchor="middle" fill="#0369a1" fontSize="11" fontWeight="bold">6 cm</text>
            <text x="90" y="112" textAnchor="middle" fill="#0369a1" fontSize="11" fontWeight="bold">16 cm</text>
            <text x="34" y="62" fill="#dc2626" fontSize="11" fontWeight="bold">12</text>
          </svg>
          Un trapezi isòsceles té bases de <strong>16 cm</strong> i <strong>6 cm</strong>, i una alçada de <strong>12 cm</strong>. Calcula el seu <strong>perímetre total</strong>.
        </>),
        es: (<>
          <svg viewBox="0 0 180 120" width="140" height="93" className="float-right ml-3 mb-1">
            <polygon points="20,100 160,100 130,20 50,20" fill="#e0f2fe" stroke="#0369a1" strokeWidth="2"/>
          ...
          Un trapecio isósceles tiene bases de <strong>16 cm</strong> y <strong>6 cm</strong>, y una altura de <strong>12 cm</strong>. Calcula su <strong>perímetro total</strong>.
        </>),
      },
      hint: { ca: "Les alçades marquen petits triangles rectangles als extrems. El catet horitzontal és (16−6)/2.", es: "Las alturas marcan pequeños triángulos rectángulos en los extremos. El cateto horizontal es (16−6)/2." },
      unit: "cm", ans: 48, tol: 0.05,
    },
    {
      id: 'ex7', num: 17,
      title: { ca: "L'apotema de l'hexàgon regular", es: "La apotema del hexágono regular" },
      statement: {
        ca: (<>
          <svg viewBox="0 0 160 160" width="120" height="120" className="float-right ml-3 mb-1">
            <polygon points="80,18 134,50 134,110 80,142 26,110 26,50" fill="#f0fdf4" stroke="#16a34a" strokeWidth="2"/>
            <polygon points="80,80 134,50 134,110" fill="#bbf7d0" stroke="#15803d" strokeWidth="1.5" strokeDasharray="5,3"/>
            <line x1="80" y1="80" x2="134" y2="80" stroke="#dc2626" strokeWidth="2" strokeDasharray="5,3"/>
            <rect x="127" y="80" width="7" height="7" fill="none" stroke="#dc2626" strokeWidth="1.5"/>
            <circle cx="80" cy="80" r="3" fill="#15803d"/>
            <text x="105" y="76" fill="#dc2626" fontSize="10" fontWeight="bold">a</text>
            <text x="106" y="67" fill="#ca8a04" fontSize="10" fontWeight="bold">6 cm</text>
          </svg>
          Un hexàgon regular té el costat de <strong>6 cm</strong>. Calcula la seva <strong>apotema</strong> (la distància del centre al centre d'un costat).
        </>),
        es: (<>
          <svg viewBox="0 0 160 160" width="120" height="120" className="float-right ml-3 mb-1">
            <polygon points="80,18 134,50 134,110 80,142 26,110 26,50" fill="#f0fdf4" stroke="#16a34a" strokeWidth="2"/>
          ...
          Un hexágono regular tiene el lado de <strong>6 cm</strong>. Calcula su <strong>apotema</strong> (la distancia del centro al centro de un lado).
        </>),
      },
      hint: { ca: "L'hexàgon es divideix en 6 triangles equilàters. L'apotema és l'alçada d'un d'ells.", es: "El hexágono se divide en 6 triángulos equiláteros. La apotema es la altura de uno de ellos." },
      unit: "cm", ans: 3 * Math.sqrt(3), tol: 0.05,
    },
    {
      id: 'ex8', num: 18,
      title: { ca: "La corda i la circumferència (II)", es: "La cuerda y la circunferencia (II)" },
      statement: {
        ca: (<>
          <svg viewBox="0 0 160 160" width="120" height="120" className="float-right ml-3 mb-1">
            <circle cx="80" cy="80" r="60" fill="#eff6ff" stroke="#3b82f6" strokeWidth="2"/>
            <line x1="20" y1="110" x2="140" y2="110" stroke="#1d4ed8" strokeWidth="2.5"/>
            <line x1="80" y1="80" x2="80" y2="110" stroke="#dc2626" strokeWidth="2" strokeDasharray="5,3"/>
            <line x1="80" y1="80" x2="140" y2="110" stroke="#16a34a" strokeWidth="1.8"/>
            <rect x="80" y="103" width="7" height="7" fill="none" stroke="#dc2626" strokeWidth="1.5"/>
            <circle cx="80" cy="80" r="3" fill="#1d4ed8"/>
            <text x="104" y="92" fill="#16a34a" fontSize="10" fontWeight="bold">10</text>
            <text x="84" y="98" fill="#dc2626" fontSize="10" fontWeight="bold">6</text>
          </svg>
          Dins d'una circumferència de <strong>radi 10 cm</strong> hi ha una corda. La distància del centre al punt mig de la corda és de <strong>6 cm</strong>. Quant mesura la <strong>longitud total de la corda</strong>?
        </>),
        es: (<>
          <svg viewBox="0 0 160 160" width="120" height="120" className="float-right ml-3 mb-1">
            <circle cx="80" cy="80" r="60" fill="#eff6ff" stroke="#3b82f6" strokeWidth="2"/>
          ...
          Dentro de una circunferencia de <strong>radio 10 cm</strong> hay una cuerda. La distancia del centro al punto medio de la cuerda es de <strong>6 cm</strong>. ¿Cuánto mide la <strong>longitud total de la cuerda</strong>?
        </>),
      },
      hint: { ca: "El radi fins a un extrem de la corda és la hipotenusa. El segment del centre al mig de la corda és un catet.", es: "El radio hasta un extremo de la cuerda es la hipotenusa. El segmento del centro al medio de la cuerda es un cateto." },
      unit: "cm", ans: 16, tol: 0.05,
    },
    {
      id: 'ex9', num: 19,
      title: { ca: "Del perímetre a la diagonal", es: "Del perímetro a la diagonal" },
      statement: {
        ca: <>Un rectangle té un perímetre de <strong>68 cm</strong> i un dels seus costats fa <strong>10 cm</strong>. Calcula la longitud de la seva <strong>diagonal</strong>.</>,
        es: <>Un rectángulo tiene un perímetro de <strong>68 cm</strong> y uno de sus lados mide <strong>10 cm</strong>. Calcula la longitud de su <strong>diagonal</strong>.</>,
      },
      hint: { ca: "P = 2×(base + altura). Aïlla l'altre costat i aplica Pitàgores.", es: "P = 2×(base + altura). Despeja el otro lado y aplica Pitágoras." },
      unit: "cm", ans: 26, tol: 0.05,
    },
    {
      id: 'ex10', num: 20,
      title: { ca: "Figura composta (Quadrat + Triangle)", es: "Figura compuesta (Cuadrado + Triángulo)" },
      statement: {
        ca: (<>
          <svg viewBox="0 0 120 160" width="90" height="120" className="float-right ml-3 mb-1">
            <rect x="20" y="90" width="80" height="60" fill="#dbeafe" stroke="#2563eb" strokeWidth="2"/>
            <polygon points="60,10 20,90 100,90" fill="#fce7f3" stroke="#9333ea" strokeWidth="2"/>
            <line x1="60" y1="10" x2="60" y2="90" stroke="#9333ea" strokeWidth="1.5" strokeDasharray="4,3"/>
            <text x="64" y="53" fill="#9333ea" fontSize="9">h?</text>
            <text x="24" y="136" fill="#2563eb" fontSize="9">6 cm</text>
          </svg>
          Un quadrat de <strong>costat 6 cm</strong> té un triangle isòsceles al damunt. La base del triangle és igual al costat del quadrat i els seus costats iguals fan <strong>5 cm</strong>. Quina és l'<strong>alçada total</strong> de la figura?
        </>),
        es: (<>
          <svg viewBox="0 0 120 160" width="90" height="120" className="float-right ml-3 mb-1">
            <rect x="20" y="90" width="80" height="60" fill="#dbeafe" stroke="#2563eb" strokeWidth="2"/>
          ...
          Un cuadrado de <strong>lado 6 cm</strong> tiene un triángulo isósceles encima. La base del triángulo es igual al lado del cuadrado y sus lados iguales miden <strong>5 cm</strong>. ¿Cuál es la <strong>altura total</strong> de la figura?
        </>),
      },
      hint: { ca: "Calcula primer l'alçada del triangle. Semi-base = 6/2 = 3.", es: "Calcula primero la altura del triángulo. Semi-base = 6/2 = 3." },
      unit: "cm", ans: 10, tol: 0.05,
    },
    {
      id: 'ex11', num: 21,
      title: { ca: "Del triangle a la hipotenusa", es: "Del triángulo a la hipotenusa" },
      statement: {
        ca: <>Un triangle rectangle té una <strong>àrea de 54 cm²</strong> i un dels seus catets fa <strong>12 cm</strong>. Calcula la longitud de la seva <strong>hipotenusa</strong>.</>,
        es: <>Un triángulo rectángulo tiene un <strong>área de 54 cm²</strong> y uno de sus catetos mide <strong>12 cm</strong>. Calcula la longitud de su <strong>hipotenusa</strong>.</>,
      },
      hint: { ca: "Àrea del triangle = (base × altura) / 2. Usa-ho per trobar l'altre catet.", es: "Área del triángulo = (base × altura) / 2. Úsalo para encontrar el otro cateto." },
      unit: "cm", ans: 15, tol: 0.05,
    },
    {
      id: 'ex12', num: 22,
      title: { ca: "El rombe des del perímetre", es: "El rombo desde el perímetro" },
      statement: {
        ca: <>Un rombe té un perímetre de <strong>40 cm</strong> i la seva diagonal major és el <strong>doble</strong> de la diagonal menor. Calcula l'<strong>àrea</strong> d'aquest rombe.</>,
        es: <>Un rombo tiene un perímetro de <strong>40 cm</strong> y su diagonal mayor es el <strong>doble</strong> de la diagonal menor. Calcula el <strong>área</strong> de este rombo.</>,
      },
      hint: { ca: "Costat = P/4 = 10. Si les semidiagonals són a i 2a: a² + (2a)² = 10².", es: "Lado = P/4 = 10. Si las semidiagonales son a y 2a: a² + (2a)² = 10²." },
      unit: "cm²", ans: 80, tol: 0.05,
    },
    {
      id: 'ex13', num: 23,
      title: { ca: "La diagonal del rectangle llarg", es: "La diagonal del rectángulo largo" },
      statement: {
        ca: <>Un rectangle fa <strong>9 cm</strong> d'amplada i <strong>40 cm</strong> de llargada. Calcula la longitud de la seva <strong>diagonal</strong>.</>,
        es: <>Un rectángulo mide <strong>9 cm</strong> de ancho y <strong>40 cm</strong> de largo. Calcula la longitud de su <strong>diagonal</strong>.</>,
      },
      hint: { ca: "Aplica directament Pitàgores amb els dos costats com a catets.", es: "Aplica directamente Pitágoras con los dos lados como catetos." },
      unit: "cm", ans: 41, tol: 0.05,
    },
    {
      id: 'ex14', num: 24,
      title: { ca: "La corda llarga", es: "La cuerda larga" },
      statement: {
        ca: (<>
          <svg viewBox="0 0 160 160" width="120" height="120" className="float-right ml-3 mb-1">
            <circle cx="80" cy="80" r="60" fill="#eff6ff" stroke="#3b82f6" strokeWidth="2"/>
            <line x1="20" y1="107" x2="140" y2="107" stroke="#1d4ed8" strokeWidth="2.5"/>
            <line x1="80" y1="80" x2="80" y2="107" stroke="#dc2626" strokeWidth="2" strokeDasharray="5,3"/>
            <line x1="80" y1="80" x2="140" y2="107" stroke="#16a34a" strokeWidth="1.8"/>
            <rect x="80" y="100" width="7" height="7" fill="none" stroke="#dc2626" strokeWidth="1.5"/>
            <circle cx="80" cy="80" r="3" fill="#1d4ed8"/>
            <text x="104" y="91" fill="#16a34a" fontSize="10" fontWeight="bold">26</text>
            <text x="84" y="97" fill="#dc2626" fontSize="10" fontWeight="bold">10</text>
          </svg>
          Dins d'una circumferència de <strong>radi 26 cm</strong> hi ha una corda. La distància del centre al mig de la corda és de <strong>10 cm</strong>. Quant mesura la <strong>longitud total de la corda</strong>?
        </>),
        es: (<>
          <svg viewBox="0 0 160 160" width="120" height="120" className="float-right ml-3 mb-1">
            <circle cx="80" cy="80" r="60" fill="#eff6ff" stroke="#3b82f6" strokeWidth="2"/>
          ...
          Dentro de una circunferencia de <strong>radio 26 cm</strong> hay una cuerda. La distancia del centro al punto medio de la cuerda es de <strong>10 cm</strong>. ¿Cuánto mide la <strong>longitud total de la cuerda</strong>?
        </>),
      },
      hint: { ca: "El radi fins a l'extrem de la corda és la hipotenusa.", es: "El radio hasta el extremo de la cuerda es la hipotenusa." },
      unit: "cm", ans: 48, tol: 0.05,
    },
    {
      id: 'ex15', num: 25,
      title: { ca: "Els catets en relació 3:4", es: "Los catetos en relación 3:4" },
      statement: {
        ca: <>Un triangle rectangle té els catets en relació <strong>3:4</strong> i la seva hipotenusa fa <strong>30 cm</strong>. Calcula quant mesura el <strong>catet major</strong>.</>,
        es: <>Un triángulo rectángulo tiene los catetos en relación <strong>3:4</strong> y su hipotenusa mide <strong>30 cm</strong>. Calcula cuánto mide el <strong>cateto mayor</strong>.</>,
      },
      hint: { ca: "Anomena els catets 3k i 4k. Aplica Pitàgores per trobar k.", es: "Llama a los catetos 3k y 4k. Aplica Pitágoras para encontrar k." },
      unit: "cm", ans: 24, tol: 0.05,
    },
  ];
