...
export const TEXTS: Translations = {
  ...
  section_1_title: { ca: "1. Recordatori", es: "1. Recordatorio" },
  section_2_title: { ca: "2. Identificació Visual", es: "2. Identificación Visual" },
  section_3_title: { ca: "3. El Teorema", es: "3. El Teorema" },
  section_4_title: { ca: "4. Problemes Reals", es: "4. Problemas Reales" },
...
export const REAL_PROBLEMS: Question[] = [
  ...
  { id: 'rp10', question: { ca: "Tenim un problema amb la mudança. Tenim un armari tombat a terra que fa 2.4 metres d'alt i 0.7 metres de fons. El sostre de l'habitació està a 2.6 metres. Si intentem aixecar l'armari posant-lo dret, la diagonal tocarà en el techo? Calcula quant mesura la diagonal de l'armari.", es: "Tenemos un problema con la mudanza. Tenemos un armario tumbado en el suelo que mide 2.4 metros de alto y 0.7 metros de fondo. El techo de la habitación está a 2.6 metros. Si intentamos levantar el armario poniéndolo de pie, ¿la diagonal tocará en el techo? Calcula cuánto mide la diagonal del armario." }, answer: 2.5, unit: 'm' },
  { id: 'rp11', question: { ca: "T'has comprat una funda per a la teva nova tablet. La pantalla mide 12 cm de ancho y 9 cm de alto. El fabricante de fundes te pide la medida de la diagonal para saber si cabe. ¿Cuántos cm hace la diagonal?", es: "Te has comprado una funda para tu nueva tablet. La pantalla mide 12 cm de ancho y 9 cm de alto. El fabricante de fundes te pide la medida de la diagonal para saber si cabe. ¿Cuántos cm hace la diagonal?" }, answer: 15, unit: 'cm' },
  ...
  { id: 'rp13', question: { ca: "El pare vol saber si el seu cotxe nou hi cap en diagonal a la plaça de pàrquing. La plaça fa 2.5 metres d'ample i 6 metres de llarg. Quina és la distància màxima en diagonal que hi ha a la plaça?", es: "Papá quiere saber si su coche nuevo cabe en diagonal en la plaza de parking. La plaza mide 2.5 metros de ancho y 6 metros de largo. ¿Cuál es la distancia máxima en diagonal que hay en la plaza?" }, answer: 6.5, unit: 'm' },
  { id: 'rp14', question: { ca: "L'avi té un hort rectangular tancat. Sabem que la diagonal que creua l'hort fa 10 metres i que un dels costats fa 6 metres. L'avi vol saber quants metres fa l'altre costat per plantar-hi tomaqueres. Calcula-ho.", es: "El abuelo tiene un huerto rectangular vallado. Sabemos que la diagonal que cruza el huerto mide 10 metros y que uno de los lados mide 6 metros. El abuelo quiere saber cuántos metros mide el otro lado para plantar tomateras. Calcúlalo." }, answer: 8, unit: 'm' },
];