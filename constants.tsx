...
export const TEXTS: Translations = {
  ...
  s1_drill_ap_title: { ca: "Practica: Calcula Perímetre (P) i Àrea (A)", es: "Practica: Calcula Perímetro (P) y Área (A)" },
...
export const REAL_PROBLEMS: Question[] = [
  { id: 'rp1', question: { ca: "Un pintor recolza l'escala a la paret. El peu queda a 8 metres de la paret i arriba a una finestra a 6 metres d'alçada. Quant mesura l'escala?", es: "Un pintor apoya la escalera en la pared. El pie queda a 8 metros de la pared y llega a una ventana a 6 metros de altura. ¿Cuánto mide la escalera?" }, answer: _a(10), unit: 'm' },
  ...
  // ── AMPLIACIÓ B: 15 problemes reals nous ────────────────────────────
  { id: 'rp15', question: { ca: "Un pont tibant té dues torres de 15 m d'alçada. Els cables que subjecten el tauler estan ancorats al terra a 20 m de la base de cada torre. Quant mesura cadascun d'aquests cables diagonals?", es: "Un puente atirantado tiene dos torres de 15 m de altura. Los cables que sujetan el tablero están anclados al suelo a 20 m de la base de cada torre. ¿Cuánto mide cada uno de estos cables diagonales?" }, answer: _a(25), unit: 'm' },
  { id: 'rp16', question: { ca: "La piscina municipal és rectangular i fa 24 m de llarg i 10 m d'ample. La monitora neda en diagonal d'un cantó a l'altre cada matí. Quants metres recorre en cada travessia?", es: "La piscina municipal es rectangular y mide 24 m de largo y 10 m de ancho. La monitora nada en diagonal de una esquina a la otra cada mañana. ¿Cuántos metros recorre en cada travesía?" }, answer: _a(26), unit: 'm' },
  { id: 'rp17', question: { ca: "Una maqueta d'una piràmide d'Egipte té una base quadrada de 120 m de costat i la longitud de la línia que va del centre de la base fins a la punta passant per la cara és de 156 m. Quina és l'alçada de la piràmide?", es: "Una maqueta de una pirámide de Egipto tiene una base cuadrada de 120 m de lado y la longitud de la línea que va del centro de la base hasta la punta pasando por la cara es de 156 m. ¿Cuál es la altura de la pirámide?" }, answer: _a(144), unit: 'm' },
  { id: 'rp18', question: { ca: "Un parapentista vola 45 m en línia recta inclinada i avança 27 m en horitzontal. Quants metres ha baixat verticalment durant el vol?", es: "Un parapentista vuela 45 m en línea recta inclinada y avanza 27 m en horizontal. ¿Cuántos metros ha bajado verticalmente durante el vuelo?" }, answer: _a(36), unit: 'm' },
  { id: 'rp19', question: { ca: "Un marc de quadre fa 60 cm d'ample i 80 cm d'alt. L'has de fer passar per una porta que fa just 1 metre d'ample. Quant mesura la diagonal del marc?", es: "Un marco de cuadro mide 60 cm de ancho y 80 cm de alto. Lo tienes que pasar por una puerta que mide justo 1 metro de ancho. ¿Cuánto mide la diagonal del marco?" }, answer: _a(100), unit: 'cm' },
  { id: 'rp20', question: { ca: "Un atleta surt del punt de partida, corre 40 m cap al nord i després 42 m cap a l'est. Quina és la distància en línia recta des del punt de partida fins on és ara?", es: "Un atleta sale del punto de partida, corre 40 m hacia el norte y después 42 m hacia el este. ¿Cuál es la distancia en línea recta desde el punto de partida hasta donde está ahora?" }, answer: _a(58), unit: 'm' },
  { id: 'rp21', question: { ca: "Una escala mecànica d'un centre comercial puja 5 metres d'alçada. La base de l'escala ocupa 12 metres de recorregut horitzontal. Quina és la longitud real de l'escala inclinada?", es: "Una escalera mecánica de un centro comercial sube 5 metros de altura. La base de la escalera ocupa 12 metros de recorrido horizontal. ¿Cuál es la longitud real de la escalera inclinada?" }, answer: _a(13), unit: 'm' },
  { id: 'rp22', question: { ca: "La diagonal d'un monitor d'ordinador mesura 80 cm i la seva amplada és de 64 cm. Quina és l'alçada de la pantalla?", es: "La diagonal de un monitor de ordenador mide 80 cm y su anchura es de 64 cm. ¿Cuál es la altura de la pantalla?" }, answer: _a(48), unit: 'cm' },
  { id: 'rp23', question: { ca: "Un sonar detecta un objecte submarí a 29 m de distància del vaixell. Sabem que l'objecte es troba a 20 m de profunditat. A quina distància horitzontal del vaixell es troba l'objecte?", es: "Un sonar detecta un objeto submarino a 29 m de distancia del barco. Sabemos que el objeto se encuentra a 20 m de profundidad. ¿A qué distancia horizontal del barco se encuentra el objeto?" }, answer: _a(21), unit: 'm' },
  { id: 'rp24', question: { ca: "Un senderista puja per un camí de muntanya. El camí fa 2.6 km de recorregut total i el desnivell vertical és d'1 km. Quant ha avançat el senderista en horitzontal?", es: "Un senderista sube por un camino de montaña. El camino mide 2.6 km de recorrido total y el desnivel vertical es de 1 km. ¿Cuánto ha avanzado el senderista en horizontal?" }, answer: _a(2.4), unit: 'km' },
  { id: 'rp25', question: { ca: "Un magatzem rectangular fa 8 m d'ample i 15 m de llarg. Un treballador recorre el magatzem en diagonal d'un extrem a l'altre. Quina distància recorre?", es: "Un almacén rectangular mide 8 m de ancho y 15 m de largo. Un trabajador recorre el almacén en diagonal de un extremo al otro. ¿Qué distancia recorre?" }, answer: _a(17), unit: 'm' },
  { id: 'rp26', question: { ca: "Una teulada a dues aigues cobreix un edifici de 8 m d'amplada. El carener (el punt més alt) es troba 3 m per sobre dels murs laterals. Quant mesura cada porció inclinada de la teulada?", es: "Un tejado a dos aguas cubre un edificio de 8 m de ancho. El caballete (el punto más alto) se encuentra 3 m por encima de los muros laterales. ¿Cuánto mide cada porción inclinada del tejado?" }, answer: _a(5), unit: 'm' },
  { id: 'rp27', question: { ca: "Un quarterback llança la pilota de rugby americà 20 m cap endavant i 15 m cap a la dreta del camp. Quina distància ha recorregut la pilota en total?", es: "Un quarterback lanza el balón de fútbol americano 20 m hacia adelante y 15 m hacia la derecha del campo. ¿Qué distancia ha recorrido el balón en total?" }, answer: _a(25), unit: 'm' },
  { id: 'rp28', question: { ca: "En un teatre, un focus penjat al sostre es troba a 7.5 m d'alçada. El tècnic de llum vol tirar un cable des del focus fins a la paret, que queda a 10 m de distància horitzontal. Quant de cable necessita?", es: "En un teatro, un foco colgado en el techo se encuentra a 7.5 m de altura. El técnico de luces quiere tirar un cable desde el foco hasta la pared, que queda a 10 m de distancia horizontal. ¿Cuánto cable necesita?" }, answer: _a(12.5), unit: 'm' },
  { id: 'rp29', question: { ca: "En un joc de taula, el tauler fa 30 cm d'ample i 40 cm de llarg. Quin és el cordill mínim necessari per travessar el tauler en diagonal d'un extrem a l'altre?", es: "En un juego de mesa, el tablero mide 30 cm de ancho y 40 cm de largo. ¿Cuál es el cordel mínimo necesario para atravesar el tablero en diagonal de un extremo al otro?" }, answer: _a(50), unit: 'cm' },
];